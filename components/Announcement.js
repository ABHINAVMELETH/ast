...
const Announcement = () => {
  ...
  <h1 className="text-5xl font-bold text-white tracking-widest glow-effect hover-glow font-orbitron md:mb-4">
    🚀 Announcements
  </h1>
</div>
          ...
          {announcements.map((announcement) => (
            <div key={announcement.id}>
              <div className="max-w-sm w-full lg:max-w-full lg:flex h-96 shadow-lg rounded-lg overflow-hidden">
               ...
               <p className="text-gray-300 text-lg font-quicksand tracking-wide italic">{announcement.description}
                </p>

                  </div>
                  <div className="flex items-center">
                    <button className="text-purple-300 hover:text-purple-500 font-semibold">
                      Learn More
                    </button>
                  </div>
                </div>
